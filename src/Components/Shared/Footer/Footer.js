...
const Footer = () => {
  ...
  return (
    <div class="container-fluid mx-auto ">
      <div class="subFooterContainer row justify-content-center mt-4 row-1 containerSide">
        <div class="subFooter w-100">
          <div class="w-75 mal">
            ...
            <div className="personal-profile__social mt-4 d-flex  gap-3">
              <a
      ...
      <div class="row d-flex  px-4 text-white containerSide">
        <div className="row brand-light-color mt-lg-5 " id="voda">
          ...
          >
            ...
            <div className="my-3">
              ...
              <h6 className="text-start ps-3">
                ...
                <span className="text-lowercase ms-2">anikh499@gmail.com</span>
              </h6>
              <h6 className="text-start ps-3">
          ...
          >
            <h3 className="paymentHeader mb-2 ms-3 text-start">
              {t("footer.payment")}
            </h3>
            <img
