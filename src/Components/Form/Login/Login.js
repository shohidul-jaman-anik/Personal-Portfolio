...
import login from '../../../Assets/form-illustrator/Sign in-pana.svg'
  ...
  return (
    <div className='form-container'>
      <div className='w-75 col-lg-4 col-md-10 col-sm-12 col-12 p-5 m-5' form-img>
        <img style={{ height: "100%", width: "100%", borderRadius: "5%" }} src={login} alt="" />
      </div>
      <div className='w-100 col-lg-6 col-md-10 col-sm-12 col-12 mx-auto   p-5 m-5 rounded-3'>
        ...
        <Form noValidate validated={validated} onSubmit={handleLogin}>
          ...
          <Button style={{ height: "60px" }} className='btn btn-lg mx-auto d-block w-100 loginBtn' variant="primary" type="submit">
            Login
          </Button>
        </Form>
        {errorElement}
        <div className='m-4'>
          <p className='text-center mt-2'>New to Personal Portfolio? <span onClick={navigateRegister} className='text-primary'>Please Register</span></p>
        ...
        <div className='input-wrapper'>
          <button onClick={() => signInWithGoogle()} className='google-auth'>
            ...
            <p className='mt-3 fw-bold'> Continue with Google </p>
          </button>
        </div>
        <ToastContainer />
      </div>
